  ...
  return (
    <div className="flex flex-col justify-center items-center gap-12 p-8 ">
      <div className="flex items-center gap-5">
        ...
        <p className="text-gray-300 text-2xl md:text-4xl font-bold">CleverBooks</p>
      </div>
      <ul className="flex list-none gap-12 text-gray-300 text-sm md:text-base">
      ...
      <div className="flex flex-col items-center gap-8 w-full mb-8 text-gray-300 text-sm md:text-base">
        <hr className="w-4/5 mx-auto border-none rounded h-1 bg-gray-300" />
